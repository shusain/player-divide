...
})({"dhbF9":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "c7532928a4487eb4";
"use strict";
...
},{}],"1aRrH":[function(require,module,exports,__globalThis) {
let players = [];
let leftSidePlayers = [];
let rightSidePlayers = [];
let disc;
const sketchFunction = (s)=>{
    s.setup = ()=>{
            ...
            if (playerName) {
                if (typeof playerName === "string") {
                    let newPlayers = playerName.split("\n").forEach((newPlayerName)=>{
                        ...
                        if (newPlayerName !== "" && players.filter((playerName)=>{
...
class Disc {
    ...
    dividePlayers() {
        this.playerWedges.forEach((wedge)=>{
            ...
            if (angle > -Math.PI / 2 && angle < Math.PI / 2) rightSidePlayers.push(wedge.name);
            else leftSidePlayers.push(wedge.name);
        });
    }
}
class PlayerWedge {
...
},{}]},["dhbF9","1aRrH"], "1aRrH", "parcelRequirea41a", {})

//# sourceMappingURL=player-divide.a4487eb4.js.map
